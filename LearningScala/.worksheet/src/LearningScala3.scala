object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(400); 
  ...
  def toUP(x : String) : String = {x.toUpperCase};System.out.println("""toUP: (x: String)String""");$skip(23); 
  println(toUP("abc"));$skip(23); 
  println(toUP("xyz"));$skip(61); 
  
  def toUp(x:String, f: String => String):String = {f(x)};System.out.println("""toUp: (x: String, f: String => String)String""");$skip(32); val res$3 = 
  toUp("abc", x=>x.toUpperCase);System.out.println("""res3: String = """ + $show(res$3));$skip(32); val res$4 = 
  toUp("xyz", x=>x.toUpperCase);System.out.println("""res4: String = """ + $show(res$4))}

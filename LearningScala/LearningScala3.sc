object LearningScala3 {
  ...
  def toUP(x : String) : String = {x.toUpperCase} //> toUP: (x: String)String
  println(toUP("abc"))                            //> ABC
  println(toUP("xyz"))                            //> XYZ
  
  def toUp(x:String, f: String => String):String = {f(x)}
                                                  //> toUp: (x: String, f: String => String)String
  toUp("abc", x=>x.toUpperCase)                   //> res3: String = ABC
  toUp("xyz", x=>x.toUpperCase)                   //> res4: String = XYZ

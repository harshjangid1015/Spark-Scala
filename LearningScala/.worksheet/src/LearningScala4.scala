...
val numList = (1 to 20).toList;System.out.println("""numList  : List[Int] = """ + $show(numList ));$skip(17); 
println(numList);$skip(36); 
val res = numList.filter(_ %3 == 0);System.out.println("""res  : List[Int] = """ + $show(res ))}
